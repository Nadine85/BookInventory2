        ...
        if (cursor.moveToFirst()) {
            ...
            decrementButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    InventoryActivity mainActivity = (InventoryActivity) getBaseContext();
                    mainActivity.decrement(id, quantity);
            ...
            incrementButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    InventoryActivity mainActivity = (InventoryActivity) getBaseContext();
                    mainActivity.increment(id, quantity);

                }

            });
            final Button callButton = (Button) findViewById(R.id.saleButton);
            callButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    InventoryActivity mainActivity = (InventoryActivity) getBaseContext();
                    mainActivity.callSupplier(id, supplierPhone);
